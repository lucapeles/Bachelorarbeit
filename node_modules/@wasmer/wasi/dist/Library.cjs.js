...
async function init$1(input) {
    if (typeof input === 'undefined') {
        input = new URL('wasmer_wasi_js_bg.wasm', (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('Library.cjs.js', document.baseURI).href)));
    }
    const imports = getImports();
...
var inited = null;
var init = function (input, force) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(inited === null || force === true)) return [3 /*break*/, 3];
                if (!!input) return [3 /*break*/, 2];
                return [4 /*yield*/, WebAssembly.compile(dataUriToBuffer(wasm_bytes))];
            case 1:
                input = _a.sent();
                _a.label = 2;
            case 2:
...
exports.JSVirtualFile = JSVirtualFile;
exports.MemFS = MemFS;
exports.WASI = WASI;
